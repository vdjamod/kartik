...
const analyzeStudentInterest = (data) => {
    ...
    // Calculate subject interest scores based solely on student score (level)
    const subjectScores = [];
    subjects.forEach((subject) => {
        const subjectName = subject.subject;
        let totalInterestScore = 0;
        ...
        subject.chapters.forEach((chapter) => {
            ...
            // Interest score for this chapter = levelWeight
            totalInterestScore += levelWeight;
        });
