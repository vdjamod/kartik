...
const TeacherPdfCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://sih-2024-5.onrender.com/create-pdf', requestBody);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-md">
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <label className="block text-gray-700 font-bold mb-2">Pdf Title:</label>
          <input
            type="text"
            value={pdfTitle}
