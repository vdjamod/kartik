...
const Home = () => {
  return (
    ...
    >
      <nav className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-4 flex justify-between items-center shadow-xl">
        <div className="flex items-center space-x-4">
          <img
            src="src/assets/image.png"
            alt="LearnLab Logo"
        ...
        <div className="space-x-8 text-white font-semibold">
          ...
          <a href="/feedback" className="hover:text-yellow-300 transition duration-300">
            Feedback
          </a>
          <a href="/signup" className="hover:text-yellow-300 transition duration-300">
            Signup
          </a>
      ...
      <div className="flex flex-col items-center justify-center text-center text-white mt-40 p-4 space-y-6">
        ...
        <a
          className="px-6 py-3 bg-yellow-500 text-xl font-bold rounded-full shadow-lg hover:bg-yellow-600 hover:shadow-2xl transition transform hover:-translate-y-1 hover:scale-105"
          href="/signup"
        >
          Get Started
        </a>
